...
/**
 * algorithm: merges string in the vector until keyword
 * 1. if the vector is empty return 0
 * 2. save the first string in the vector into string variable
 * 3. in a loop merge the string in the vector until the keyword
 * 4. return the string
 * Parameters: vector<string>vect
 * Returns: returns "0" if vector is empty, returns the merged string
*/
